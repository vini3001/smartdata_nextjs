...
const EditToolbar = (props: any) => {
  ...
  const handleClick = () => {
    ...
    setRows((oldRows: any) => [...oldRows, { id, type: '', external_code: '',  external_key:  '', isNew: true }])
...
export default function GridPerson({ data, actionUpsert, actionDelete }: any) {
  ...
  const processRowUpdate = (newRow: any) => {
    ...
    actionUpsert({
      ...
      type: newRow.type,
      external_code: newRow.external_code,
      external_kay: newRow.external_kay
    })
