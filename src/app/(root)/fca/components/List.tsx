            ...
            <TableCustom sx={{ minWidth: 650, borderCollapse: 'separate', borderSpacing: '10px 10px'  }} aria-label="simple table">
                <TableHead>
                    <TableRow
                        ...
                        <TableCell sx={{backgroundColor: '#D6D9EF'}} align="center">No Prazo</TableCell>
                        <TableCell sx={{backgroundColor: '#D6D9EF'}} align="center">Com Qualidade</TableCell>
                        <TableCell sx={{backgroundColor: '#D6D9EF'}} align="center">Com Efetividade</TableCell>
