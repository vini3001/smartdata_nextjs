...
const EditToolbar = (props: any) => {
  ...
  const handleClick = () => {
    ...
    setRows((oldRows: any) => [...oldRows, { id, type_communication: '', method_communication: '',
  ...
  return (
    <CustomToolbar>
      <Typography>Exceções de Envio</Typography>
...
export default function GridExceptions({ data, actionUpsert, actionDelete }: any) {
  ...
  const processRowUpdate = (newRow: any) => {
    ...
    actionUpsert({
      ...
      type_communication: newRow.type_communication,
      method_communication: newRow.method_communication,
      information: newRow.information
    })
  ...
  const columns: GridColDef[] = [
    ...
    {
      field: 'method_communication',
      headerName: 'Método de Comunicação',
      flex: 1,
      editable: true,
      valueParser: (value: any) => {return value !== undefined ? value.substring(0, 100) : ''},
      preProcessEditCellProps: (params: any) => {
