...
import PaginatedItems from "./IndicatorsPaginate";
import { useState } from "react";
import { Box, SvgIcon } from "@mui/material";
import CreateIndicator from "./ModalCreate";
import ToolsBand from "@/app/components/ToolsBand";


export default function ClientGovernanceIndicators() {
    return (
      <Box>
        <ToolsBand text={"Boa Noite, Cláudio"} sideComponent={<AddButton />} />
        <GovernanceIndicatorsBody />
      </Box>
