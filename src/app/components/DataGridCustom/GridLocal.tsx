...
const EditToolbar = (props: any) => {
  ...
  const handleClick = () => {
    ...
    setRows((oldRows: any) => [...oldRows, { id, id_client: '', name_local: '', name_speak: '', type_local: '', preposition_speak: '', isNew: true }])
...
export default function GridLocal({ data, actionUpsert, actionDelete }: any) {
  ...
  const processRowUpdate = (newRow: any) => {
    ...
    actionUpsert({
      ...
      name_local: newRow.name_local,
      type_local: newRow.type_local,
      name_speak: newRow.name_speak,
      preposition_speak: newRow.preposition_speak
    })
  ...
  const columns: GridColDef[] = [
    ...
    {
        field: 'preposition_speak',
        headerName: 'Preposição Speak',
        flex: 1,
        editable: true,
        valueParser: (value: any) => {return value !== undefined ? value.substring(0, 100) : ''},
        preProcessEditCellProps: (params: any) => {
